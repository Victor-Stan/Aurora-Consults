            ...
            <div className="grid gap-8 md:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-[#6B7280]">
                  Communicate with the Aurora Consults admin and stay up-to-date
                ...
                <div className="mt-6 grid gap-4">
                  <div className="rounded-lg border bg-white p-4 shadow-sm dark:bg-gray-950 dark:border-gray-800">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        <Avatar className="h-10 w-10 shrink-0">
                          <img
                            src="https://th.bing.com/th/id/OIP.N-6ILzgcugo0Ka2JDlYQqwHaHn?w=640&h=658&rs=1&pid=ImgDetMain"
                            alt="Admin Avatar"
                          />
                    ...
                    <div className="mt-4 prose prose-sm">
                      <p>
                        Hello, we wanted to let you know about some exciting
                        updates to our programs and services. Please let us know
                  ...
                  <div className="rounded-lg border bg-white p-4 shadow-sm dark:bg-gray-950 dark:border-gray-800">
                    ...
                    <div className="mt-4 prose prose-sm">
                      <p>
                        ...
                        educational program. Check the dashboard for more
                        details.
                      </p>
                    </div>
                    <div className="mt-4 flex items-center justify-end gap-2">
                  ...
                  <div className="rounded-lg border bg-white p-4 shadow-sm dark:bg-gray-950 dark:border-gray-800">
                    ...
                    <div className="mt-4 prose prose-sm">
                      <p>
                        Please find the updated policy document attached. Let us
              ...
              <div>
                <img
                  src="https://cdn3d.iconscout.com/3d/premium/thumb/communication-5665583-4745548.png"
                  alt="Communication"
