      ...
      <main className="flex-1">
        <section className="bg-white py-12">
          <div className="container mx-auto px-4 md:px-6">
            <h2 className="text-3xl font-bold tracking-tight text-[#1F2937]">Contact Us</h2>
            <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-2">
              <div className="rounded-lg bg-[#F3F4F6] p-6 shadow-sm">
                <h3 className="text-xl font-bold text-[#1F2937]">Get in Touch</h3>
                <form className="mt-6 space-y-4">
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-medium text-[#6B7280]">
                      Message
                    </label>
                    <textarea
                      id="message"
              ...
              <div className="rounded-lg bg-[#F3F4F6] p-6 shadow-sm">
                <h3 className="text-xl font-bold text-[#1F2937]">Our Location</h3>
                <div className="mt-6 space-y-4">
                  <div>
                    <h4 className="text-lg font-medium text-[#1F2937]">Head Office</h4>
                    <p className="text-[#6B7280]">123 Main Street, Helsinki, Finland 12345</p>
                  </div>
                  <div>
